...
function createRepoWidgets(repoData) {
    ...
    jQuery('#widgetSection').prepend(`
        <div class="p-3 my-3 mx-auto rounded openWidget" id="${componentId}">
            <h3 class="text-center mt-2 mb-4 text-dark"> Create Repository </h3>
            <form method="post" action="#" class="w-100 text-center">
                <div class="form-group row">
                    <label for="${componentId}-name" class="col-sm-3 col-form-label">Repo Name</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="${componentId}-Desc" class="col-sm-3 col-form-label">Repo Description</label>
                    <div class="col-sm-9">
